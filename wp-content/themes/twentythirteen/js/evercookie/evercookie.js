...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = 'js/evercookie/evercookie_cache.php?name=' + name;
	}
	else
	{
		...
		$.ajax({
			url: 'js/evercookie/evercookie_cache.php?name=' + name,
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = 'js/evercookie/evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		...
		$.ajax({
			url: 'js/evercookie/evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = 'js/evercookie/evercookie_png.php?name=' + name;
		}
		else
		{
